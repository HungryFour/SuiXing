...
-(void)showFrame
{
    NSLog(@"view frame: origin=(%f,%f) size=(%f,%f)",self.frame.origin.x,self.frame.origin.y,self.frame.size.width,self.frame.size.height);
}
...
-(void)setSize_width:(float)size_width
{
...
-(void)setSize_height:(float)size_height
{
...
-(void)setOrigin_x:(float)origin_x
{
...
-(void)setOrigin_y:(float)origin_y
{
    self.frame = CGRectMake(self.frame.origin.x, origin_y, self.frame.size.width, self.frame.size.height);
}
...
-(void)setContraint{
//    UIView * _boxV = [[UIView alloc]init];
//    NSDictionary * dict1 = NSDictionaryOfVariableBindings(_boxV);
//    NSDictionary * metrics = @{@"hPadding":@5};
//    NSString *vf1 = @"|-hPadding-[_boxV]-hPadding-|";
//    NSString *vf10 = @"V:|-25-[_boxV]";
//    NSString *vf13 = @"V:|-hPadding-[_boxV]|";

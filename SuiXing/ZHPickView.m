...
-(void)setUpPickView{
    ...
    pickView.frame=CGRectMake(0, ZHToobarHeight, SX_SCREEN_WIDTH, pickView.frame.size.height);
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    datePicker.frame=CGRectMake(0, ZHToobarHeight, SX_SCREEN_WIDTH, datePicker.frame.size.height);
